...
import static com.mastercard.developers.mbep.util.EncryptionConfigUtil.getEncryptionConfig;

public final class RequestHelper {

    private static final String BASE_URL = "mastercard.mbep.client.api.base.path";
    private static final String CONSUMER_KEY = "mastercard.mbep.client.ref.app.consumer.key";
    private static final String KEYSTORE_PATH = "mastercard.mbep.client.p12.path";
    private static final String KEYSTORE_ALIAS = "mastercard.mbep.client.ref.app.keystore.alias";
    private static final String KEYSTORE_PASSWORD = "mastercard.mbep.client.ref.app.keystore.password";
    private static final String TYPE_PK_CS12 = "PKCS12";

    private static final String READ_TIME_OUT = "mastercard.mbep.client.ref.app.read.timeout";
    ...
    public static String resourceContent(String classpathName) {
        try (InputStream inputStream = RequestHelper.class.getClassLoader().getResourceAsStream(classpathName)){
