...
class RequestControllerTest {
    ...
    void eligibilities() throws ApiException {
        ...
        when(mbepService.checkEligibility(any())).thenReturn(eligibility);
    ...
    void redemptions() throws ApiException{
        ...
        when(mbepService.redemption(any())).thenReturn(redemptionInfo);
    ...
    void benefits() throws ApiException {
        ...
        when(mbepService.benefits()).thenReturn(partnerBenefitDetails);
